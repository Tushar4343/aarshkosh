...
//AArshgranths
Route::get('/home', 'AarshGranthController@index');
Route::get('/home/granths/{id}', 'AarshGranthController@granths');
Route::get('/home/chapters/{id}', 'AarshGranthController@chapters');
Route::get('/home/chapter/{id}', 'AarshGranthController@chapter')->name('aarshgranth.chapter');
