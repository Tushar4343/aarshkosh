                    ...
                    <div class="card card-primary card-outline shadow-5-strong">
                        <div class="card-body box-profile">
                            <div class="form-group">
                                ...
                                <select id="select_language" class="select2bs4" style="width: 100%;">
...
<script>
    $(document).ready(function () {
        ...
        $('#select_language').change(function () {
            ...
            if (language_id != 0) {
                $.ajax({
                    url: '{{ url("/home/granths")}}/' + language_id,
                    dataType: 'json',
                    beforeSend: function () {
        ...
        $('#select_granth').change(function () {
            ...
            if (granths_id != 0) {
                $.ajax({
                    url: '{{ url("/home/chapters")}}/' + granths_id,
                    dataType: 'json',
                    beforeSend: function () {
        ...
        $('#select_chapter').change(function () {
            ...
            if (chapter_id != 0) {
                $.ajax({
                    url: '{{ url("/home/chapter")}}/' + chapter_id,
                    dataType: 'html',
                    beforeSend: function () {
