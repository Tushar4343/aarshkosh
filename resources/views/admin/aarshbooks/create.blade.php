...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.aarshbook.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.aarshbooks.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aarsh_book') ? 'is-invalid' : '' }}" type="text" name="aarsh_book" id="aarsh_book" value="{{ old('aarsh_book', '') }}" required>
